...
/*
    ...
    Cmdline:
        sokol-shdc -i source/shader/cube.glsl -o source/shader/cube.odin -l glsl430:metal_macos:hlsl5 -f sokol_odin
...
/*
    ...
    vertex main0_out main0(main0_in in [[stage_in]], constant vs_params& _19 [[buffer(1)]])
    {
        main0_out out = {};
